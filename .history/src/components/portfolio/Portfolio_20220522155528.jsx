  ...
  const data = [
    {
      ...
      comments: 'Don't miss the opportunity to watch your favorite movies and series on this Netflix, now completely decentralized thanks to its IPFS videos, crypto payment and NFT subscription.',
