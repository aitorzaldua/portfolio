...
const Blog = () => {
  const data = [
    ...
    },
    {
      ...
      note: "Solana, nacida en 2017, es un blockchain de prueba de participación (PoS) basado en la práctica bizantina de tolerancia a fallas (PBFT) conAWS está esponsorizando el lenguaje de programación Rust y su motivo es bien evidente: Rust le permite a AWS escribir software con alto rendimiento y máximo aprovechamiento de la infraestructura, a la vez de garantizar la seguridad tanto de los sistemas como del entorno de red. Definitivamente, Rust se está volviendo popular en los entornos Cloud, veamos por qué",
      link: "https://medium.com/p/300238e68053",
      place: "Medium",
    },
    {
